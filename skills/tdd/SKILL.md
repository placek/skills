...
- **Refactoring is not part of the loop.** It belongs to the review stage (see the `code-review` skill) or to a separate `refactor` session, not the red → green implementation cycle.
